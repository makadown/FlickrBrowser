...
public class MainActivity extends BaseActivity {
    ...
    /**
     * NOTA: Se puede crear desde http://www.jsonschema2pojo.org/  utilizando el contenido de
     * https://api.flickr.com/services/feeds/photos_public.gne?tags=android,lollipop&format=json&nojsoncallback=1
     * quitando los I'll porque no los parsea bien.
     */
    //String rawUrl = "https://api.flickr.com/services/feeds/photos_public.gne?tags=android,lollipop&format=json&nojsoncallback=1";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flickRecyclerViewAdapter =
                new FlickRecyclerViewAdapter(MainActivity.this, new ArrayList<Photo>());
    ...
    public class ProcessPhotos extends GetFlickrJsonData {
        ...
        public class ProcessData extends DownloadJsonData {
            ...
            protected void onPostExecute(String webData) {
                ...
                flickRecyclerViewAdapter.loadNewData(getPhotos());
            }
        }
    }
